...
#===================Python Variables=======================
menu_category = ["Tea & Coffee","Beverages","Fast Food","Special Item","Starters","Main Course","Dessert"]

menu_category_dict = {"Tea & Coffee":"1 Tea & Coffee.txt","Beverages":"2 Beverages.txt",
                "Fast Food":"3 Fast Food.txt","Special Item":"4 Special Item.txt",
...
def bill_button_operation():
    ...
    if ans=="yes":
        ...
        st = "\t\t\t\tSmart Hotel\n\t\t\t Dhaka, Tangail-411061\n"
        st += "\t\t\tGST.NO:- 81Md.AtikBhuiyan\n"
        st += "-"*61 + "BILL" + "-"*61 + "\nDate:- "
...
root.title("Welcome to Smart Hotel")
...
title_label = Label(title_frame, text="Smart Hotel",
